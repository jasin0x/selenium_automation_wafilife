...
public class bookDetailsPage_test extends DriverSetup {
    ...
    public void orderConfirmation() throws InterruptedException {
        ...
        //bookDetailsPage.clickOnElement(bookDetailsPage.districtDropdown);
        //js.executeScript("document.querySelector('.select2-results__options').scrollTop=500");
        //actions.scrollToElement(bookDetailsPage.getElement(bookDetailsPage.targetDistrict)).build().perform();
        //bookDetailsPage.scrolltoElement(bookDetailsPage.selectedDistrict);
        select = new Select(bookdetailsAndOrderPage.getElement(bookdetailsAndOrderPage.areaDropdown));
